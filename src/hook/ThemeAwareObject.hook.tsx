import React from 'react';import { useTheme } from '../globals/Theme';
...
type Generator<T extends {}> = (theme: ITheme) => T;// Creating our custom hook
const useThemeAwareObject = <T extends {}>(fn: Generator<T>) => {
  // Consume the provided value of our theme context
  const { theme } = useTheme();  // Generate the object based on the current theme 

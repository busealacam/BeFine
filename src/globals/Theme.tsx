...
import { DEFAULT_DARK_THEME, DEFAULT_DARK_THEME_ID } from './colors';
import { DEFAULT_LIGHT_THEME, DEFAULT_LIGHT_THEME_ID } from './colors';
import { ITheme } from "../interface/ITheme"; // Our context provider will provide this object shape
...
export const ThemeProvider = React.memo<Props>((props) => {
    ...
    const [theme, setTheme] = React.useState<ITheme>(props.initial);  // Implement a method for toggling the Theme
